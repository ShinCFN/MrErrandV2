...
public class VerifiedListAdapter extends RecyclerView.Adapter<VerifiedListAdapter.MyViewHolder> {
    ...
    public VerifiedListAdapter(Context context, ArrayList<Rider> list) {
